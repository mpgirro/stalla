...
import dev.stalla.model.googleplay.GoogleplayBase2
 ...
 */
@InternalApi
internal object GoogleplayWriter2 : NamespaceWriter() {
    ...
    private fun Element.appendCommonElements(play: GoogleplayBase2) {
