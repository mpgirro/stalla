...
import dev.stalla.builder.validating.podcast.ValidatingPodcastItunesBuilder2
 ...
 */
public data class PodcastItunes2(
    ...
    public companion object Factory : BuilderFactory<PodcastItunes2, PodcastItunesBuilder2> {

        /** Returns a builder implementation for building [PodcastItunes2] model instances. */
        @JvmStatic
        override fun builder(): PodcastItunesBuilder2 = ValidatingPodcastItunesBuilder2()
    }
}
