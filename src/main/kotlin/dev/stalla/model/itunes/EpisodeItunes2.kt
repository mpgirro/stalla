...
import dev.stalla.builder.validating.episode.ValidatingEpisodeItunesBuilder2
 ...
 */
public data class EpisodeItunes2(
    ...
    public companion object Factory : BuilderFactory<EpisodeItunes2, EpisodeItunesBuilder2> {

        /** Returns a builder implementation for building [EpisodeItunes2] model instances. */
        @JvmStatic
        override fun builder(): EpisodeItunesBuilder2 = ValidatingEpisodeItunesBuilder2()
    }
}
