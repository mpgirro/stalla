...
internal class GoogleplayWriter2Test : NamespaceWriterTest() {

    override val writer = GoogleplayWriter2
    ...
    internal fun `should not write googleplay tags to the channel when the data is blank`() {
        val categories = listOf(
            ItunesStyleCategory2.Simple(" "),
            ItunesStyleCategory2.Nested(" ", ItunesStyleCategory2.Simple("subcategory")),
            ItunesStyleCategory2.Nested("nested", ItunesStyleCategory2.Simple(" "))
        )
